(function () {
  ...
  function addPeakMarker(map, points, name) {
    var maxEle = -Infinity, peakPt = null;
  ...
  function initTrackMap(mapId, elevationId, data, peakName) {
    ...
    addPeakMarker(map, points, peakName || "Summit");
    addHRLegend(map);
  ...
  document.addEventListener("DOMContentLoaded", function () {
    loadJSON("sanbernardino-track.json", function (data) {
      initTrackMap("sanbernardino-map", "sanbernardino-elevation", data, "San Bernardino Peak");
    });
  });
})();
